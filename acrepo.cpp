...
//{
//    repo = new AcGit::Repository(directory);

//    // check if there is any changes to the working directory
//    AcGit::Diff *workingDirChanges = new AcGit::QGitDiff (repo);
...
//        Commit* workDir = new Commit(AcGit::QGitCommit(), lane, 1);
...
//    AcGit::Commit walkCommit = repo.lookupCommit(repo.head().oid());
//    AcGit::QGitRevWalk walker(repo);

//    QVector<AcGit::Sha> nextCommits;
...
//    walker.setSorting(AcGit::QGitRevWalk::Topological);
...
//AcGit::Repository *acRepo::getRepo() const
//{
//    return repo;
//}

//void acRepo::setRepo(const AcGit::Repository &value)
//{
//    repo = value;
//}

//void acRepo::addCommit(const AcGit::Commit &commit)
//{
...
//    allBranches = repo.showAllBranches (AcGit::QGitRepository::QGIT_LOCAL);
//    allBranches.append(repo.showAllBranches (AcGit::QGitRepository::QGIT_REMOTE));
...
//    try
//    {
//            AcGit::QGitRef ref = repo.lookupRef("refs/tags/" + tagName);
...
//                AcGit::QGitTag tag = repo.lookupTag(ref.oid());

//                AcGit::QGitObject obj = tag.target();
...
//    try
//    {
//            AcGit::QGitRef ref = repo.lookupRef("refs/remotes/" + branchName);
...
//        try
//        {
//            AcGit::QGitRef ref = repo.lookupRef("refs/heads/" + branchName);
...
//AcGit::Commit *acRepo::getCommitAtIndex(int index)
//{
//    AcGit::Commit *commitAtIndex = nullptr;
//    if (index < commits.size())
//    {
//        QList <AcGit::Commit *> commitsList = repo->getCommits();
//        commitAtIndex = commitsList.at(index);
//    }
...
//                                              QVector<AcGit::QGitOId> &nextCommits, int activeRow,
...
// */
//Commit* acRepo::populateCommit(AcGit::Commit &commit, QVector<AcGit::Sha> &nextCommits, Commit *prevCommit)
//{
...
//    {
//        AcGit::QGitOId nextCommit = nextCommits.at(nextCommitIndex);
...
//        int a = 0;
//        foreach (AcGit::QGitOId oid, nextCommits)
//        {
